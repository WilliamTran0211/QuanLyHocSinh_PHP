...
@section('content')
<h2 class="d-flex justify-content-center mb-3">Thêm giáo viên</h2>
<div class="container">
  <div class="row">
    <div class="col-lg-12">
      <div class="d-flex justify-content-center">
        <form style="width:300px" name="giaovien" action="{{route('LuuGiaoVien')}}" method="post" onsubmit="return KiemTraGiaoVien();">
          {{csrf_field()}}
          <div class="mb-3">
            <div class="input-group">
              <input name="tengiaovien" class="form-control" type="text" placeholder="Tên giáo viên" />
            </div>
            <p id="error-name" class="text-danger error"></p>
          </div>
          <div class="mb-3">
            <div class="input-group">
              <input name="ngaysinh" class="form-control" type="date" placeholder="Ngày sinh" />
            </div>
